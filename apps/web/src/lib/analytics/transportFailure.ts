/**
 * Which failed GraphQL requests the web app reports to PostHog
 * (JEF-349, JEF-370).
 *
 * Mirrored in apps/mobile/src/lib/analytics/transportFailure.ts so an API
 * outage looks the same from either client; transportFailureParity.test.ts
 * keeps the two copies identical below this comment.
 */
