 ...
 * trash purge, push notifications). Accepts either the route's own dedicated
 * secret (for manual/external triggering) or CRON_SECRET — the shared secret
 * the Cloud Scheduler jobs in infra/gcp/scheduler.tf send as
